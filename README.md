...
Linux: [![Circle CI](https://circleci.com/gh/conda-forge/r-pvclust-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/r-pvclust-feedstock)
OSX: [![TravisCI](https://travis-ci.org/conda-forge/r-pvclust-feedstock.svg?branch=master)](https://travis-ci.org/conda-forge/r-pvclust-feedstock)
Windows: [![AppVeyor](https://ci.appveyor.com/api/projects/status/github/conda-forge/r-pvclust-feedstock?svg=True)](https://ci.appveyor.com/project/conda-forge/r-pvclust-feedstock/branch/master)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-pvclust/badges/version.svg)](https://anaconda.org/conda-forge/r-pvclust)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/r-pvclust/badges/downloads.svg)](https://anaconda.org/conda-forge/r-pvclust)
